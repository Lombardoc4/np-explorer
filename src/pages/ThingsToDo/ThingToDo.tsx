...
const TTDSection = ({ ttd }: { ttd: IThingToDo }) => {
  ...
  return (
    <div className='grid gap-8'>
      {ttd.images.length > 0 && (
        <div className='rounded-lg bg-black p-4 pb-0 text-white'>
          <div className='pb-4'>
            {ttd.title && (
          ...
          <div className='overflow-hidden rounded-lg border border-white'>
            <ImgGrid images={ttd.images} parallax />
          </div>
          <div className='grid items-center gap-4 py-4 sm:grid-cols-3 lg:grid-cols-4'>
            {ttd.duration && (
              <div>
      ...
      <div className='grid grid-cols-4 gap-8'>
        <div className='col-span-full'>
          <p dangerouslySetInnerHTML={{ __html: ttd.longDescription }} />
          <Link
            className='my-4 flex items-center gap-1 text-sm italic hover:underline'
            to={ttd.url}
          >
